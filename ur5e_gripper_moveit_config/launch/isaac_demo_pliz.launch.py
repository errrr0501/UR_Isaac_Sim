...
def generate_launch_description():
    ...
    # pilz_planner_path = os.path.join(
    #     get_package_share_directory("ur5e_gripper_moveit_config"),
    #     "config",
    #     "pilz_industrial_motion_planner_planning.yaml",
    # )
    # pilz_cartesian_limit_path = os.path.join(
    #     get_package_share_directory("ur5e_gripper_moveit_config"),
    #     "config",
    ...
    # pilz_planning_pipeline_config["move_group"].update(pilz_planner_path)
    # pilz_planning_pipeline_config["pilz_industrial_motion_planner"].update(pilz_planner_path) 

    # # pilz_cartesian_limits_yaml = load_yaml("ur_pilz_demo", "config/pilz_cartesian_limits.yaml")
    # pilz_planning_pipeline_config["robot_description_planning"].update(pilz_cartesian_limit_path)

    moveit_config = (
        MoveItConfigsBuilder("ur5e" , package_name="ur5e_gripper_moveit_config")
        .robot_description(
